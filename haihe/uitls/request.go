...
//func Request(url string, method string, parameters map[string]string, data map[string]string,
//	head map[string]string, timeout time.Duration) ([]byte, error) {
//	req, err := newRequest(url, method, parameters, data, head)
//	if err != nil {
//		return nil, err
//	}
//
...
//func newRequest(fullUrl string, method string, parameters map[string]string, data map[string]string, head map[string]string) (*HTTPRequest, error) {
//	var q []string
//	for k, v := range parameters {
//		if v == "" {
//			continue
...
//func doRequest(request *HTTPRequest, timeout time.Duration) ([]byte, error) {
//	client := &http.Client{
//		Timeout: timeout,
//	}
//	var req *http.Request
